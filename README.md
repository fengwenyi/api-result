...
[api-result结合Spring Boot使用实例](https://github.com/fengwenyi/APIExample/tree/api-result-sample)
...
public class ApiResultUtils {
     ...
     * @return {@link ResultApiModel}
     */
    public static ResultApiModel<Integer, ?> error(int code, String message) {
...
public class PageResultUtils {
    ...
    public static <T> ResultPageModel<T> success(T data, long total, int size, long pages, long current) {
        return ResultPageHelper.success("Success", data, total, size, pages, current);
    }
